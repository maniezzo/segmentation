...
\Title{Optimal Linear Covering Changepoint Analysis}
...
Tutta la letterature, statistica e forecasting

\section{The extended set covering model} \label{sec:SCPmodel}
