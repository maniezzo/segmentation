...
Finally, Table \ref{tab:DYNPseriesAICQRMSE} also compares the relative effectiveness of TSSP and WSB. The median percentage error of WSB is generally small, with medians below 3\% and equal to 0\% for the M6 series. However, in some cases the heuristic solutions fail to converge to an acceptable quality.
