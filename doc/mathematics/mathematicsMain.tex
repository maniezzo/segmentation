...
\highlight{The relaxation of the set partitioning formulation to a set covering problem relinquishes the exactness guarantee: the resulting solution is heuristic in nature because overlapping runs must be resolved through postprocessing. Although this compromise yields significant computational gains, it should not be conflated with the global optimality guaranteed by the exact TSSP formulation.}
