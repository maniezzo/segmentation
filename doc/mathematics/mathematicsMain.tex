...
\begin{itemize}
	...
	Bounds on the length of each segment prevent over-fragmentation and excessively long segments. For a segment defined by start and end indices $(s,e)$, this constraint is expressed as
	\begin{equation}
