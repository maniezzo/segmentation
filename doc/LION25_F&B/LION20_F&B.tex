...
\paragraph{Aesthetic Clarity}: A model must be parsimonious enough to be explained to stakeholders. Overly complex models with numerous small segments may achieve better fit but are often dismissed as "noisy" or "unstructured" (MDPI, 2024).
...
Burnham, K. P., Anderson, D. R. (2003). Model Selection and Multimodel Inference: A Practical Information-Theoretic Approach.

Datadog Engineering (2017). Piecewise regression: When one line simply isn't enough.

MDPI (2024). A Selective Review on Information Criteria in Multiple Change Point Detection.

arXiv (2025). Online detection of forecast model inadequacies using forecast errors.
