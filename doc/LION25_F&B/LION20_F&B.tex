...
\author{Vittorio Maniezzo\inst{1}\orcidID{0000-0002-1220-1235} \and
	Morteza Sheykhizadeh\inst{3}\orcidID{2222--3333-4444-5555}}

%
\authorrunning{V. Maniezzo, M. Sheykhizadeh}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{University of Bologna, Cesena, Italy\\
\email{vittorio.maniezzo@unibo.it, morteza.sheykhizadeh@studio.unibo.it}\\
